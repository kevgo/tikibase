...
impl Message {
  ...
  pub fn from_issue(issue: Issue) -> Self {
    match issue {
            ...
            Issue::HeadingLevelDifferentThanConfigured { location, configured_level, configured_title: _, actual_level, actual_title} => Self{
            ...
            Issue::InvalidTitleRegex { regex, problem, file } => Self{
